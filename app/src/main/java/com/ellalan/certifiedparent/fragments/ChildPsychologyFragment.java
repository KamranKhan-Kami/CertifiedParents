...
public class ChildPsychologyFragment extends Fragment {
    ...
    public ChildPsychologyFragment() {
        // Required empty public constructor
    }

    public static ChildPsychologyFragment newInstance(CategoryStatements statement) {
        ChildPsychologyFragment fragment = new ChildPsychologyFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.i("Log","ChildPsychology Fragment onCreateView Called...");
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        callingActivity.getSupportActionBar().setTitle("Child Psychology");
        ...
        view.findViewById(R.id.fabprevious).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mListener.LoadPreviousChildPsychologyStatement();
            }
        });
