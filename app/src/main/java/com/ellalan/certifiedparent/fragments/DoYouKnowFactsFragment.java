...
public class DoYouKnowFactsFragment  extends Fragment {
    ...
    Context context;
    public DoYouKnowFactsFragment() {
        // Required empty public constructor
    }

    public static DoYouKnowFactsFragment newInstance(CategoryStatements statement) {
        DoYouKnowFactsFragment fragment = new DoYouKnowFactsFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        callingActivity.getSupportActionBar().setTitle("Do You Know Facts");
        ...
        view.findViewById(R.id.fabprevious).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mListener.LoadPreviousKnowFactsStatement();
            }
        });
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            Log.i("Log","DoYouKnowFacts argument not null...!!");
