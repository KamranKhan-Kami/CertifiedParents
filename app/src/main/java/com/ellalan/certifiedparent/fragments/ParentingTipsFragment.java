...
public class ParentingTipsFragment extends Fragment {
    ...
    Context context;
    public ParentingTipsFragment() {
        // Required empty public constructor
    }

    public static ParentingTipsFragment newInstance(CategoryStatements statement) {
        ParentingTipsFragment fragment = new ParentingTipsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.i("Log","ParentingTipsFragment onCreateView Called");
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        callingActivity.getSupportActionBar().setTitle("Parenting Tips");
        ...
        view.findViewById(R.id.fabprevious).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mListener.LoadPreviousParentingTipsStatement();
            }
        });
